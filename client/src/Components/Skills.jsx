    ...
    <Section id='skills' ref={element}>
      ...
      <div className="skills">
        ...
        <div className="skills_content">
          <p className='title'>
            This are the main skills that I been developing lately.
          </p>
          <div className="description">
            Most of the skills that I learned were: HTML, CSS, Javascript, 
            React, Redux, Tailwind, Styled-Components, Material UI, Framer-Motion, Chakra UI, Express, 
