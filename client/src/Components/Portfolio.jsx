		...
		<Section id='portfolio' ref={element}>
			...
			<div className='grid'>
				<motion.div
					...
					<a href='https://psico-app.vercel.app/'>
						<AiFillPlayCircle />{" "}
					</a>
					<a href='https://github.com/tomasld13/PF-psicoApp'>
						<AiFillGithub />{" "}
					</a>
				</motion.div>
				<motion.div
					...
					<a href='https://pi-countries-pied.vercel.app/'>
						<AiFillPlayCircle />{" "}
					</a>
					<a href='https://github.com/ezefaz/PI-Countries'>
						<AiFillGithub />{" "}
					</a>
				</motion.div>
				<motion.div
